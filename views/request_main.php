  ...
  <section id="container">
    ...
    <section id="main-content">
      <section class="wrapper">
       <h3><i class="fa fa-angle-right"></i>Request Page</h3>       
                  ...
                  <div class="form-panel">
                      <form method="post" class="form-horizontal style-form">
                          <div class="form-group">
                            <label class="col-sm-2 col-sm-2 control-label">Receiver Username</label>
                          ...
                          <div class="col-sm-10">
                            <input type="text" name="staff_username" class="form-control" placeholder="user.name" required>
                          </div>
                          </div>
                          <div class="form-group">
                              ...
                              <select name="pr_name" class="form-control" required>
                                ...
                                ?>
                                  <option value="<?= $row['pr_name'] ?>"><?= $row['pr_name'] ?> | <?= $row['pr_name'] ?> | <?= $row['pr_name'] ?></option>
                                <?php } ?>
                              </select>
                            </div>
                            </div>
