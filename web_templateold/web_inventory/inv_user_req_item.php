            ...
            <div class="form-three widget-shadow">
              <form method="post" class="form-horizontal style-form">
                <div class="form-group">
                  ...
                  <input type="hidden" name="set_status" class="form-control" value="Pendding">
                ...
                <div class="col-sm-8">
                  <select  id="dropdown" name="req_status" class="form-control" required>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <select id="dropdown1" name="pr_name" class="form-control" required>
                      <option value="">-- SELECT --</option>
                      <?php 
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                   <select name="assetof" class="form-control" id="dropdown2" required>
                      <option value="">-- SELECT --</option>
