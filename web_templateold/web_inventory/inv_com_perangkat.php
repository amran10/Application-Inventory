...
{    
  ...
  if($num == 0){
    ...
    // var_dump($query);die();
    if ($query) {
      header("Location: ./inv_com_perangkat.php?ntf=1");  
    } else {
      header("Location: ./inv_com_perangkat.php?ntf=3");
    }
  } else {
    header("Location: ./inv_com_perangkat.php?ntf=2");
  }
} 
...
{    
  ...
  $num = mysql_num_rows($cek);
  if($num == 1){
    $query = mysql_query("UPDATE tb_product SET pr_name ='$pname', pr_brand = '$brand' , pr_purchase = '$pdate' , pr_sn = '$sn', pr_po_no = '$po', pr_category ='Perangkat Komputer', pr_asset_of = '$asset', pr_status = '$pr_status', monitoring = '$monitoring' WHERE pr_id='$cid'");
    if($query){
      header("Location: ./inv_com_perangkat.php?ntf=5");                                                  
    } else {
...
if(isset($_POST['delete']))
{
  ...
  if($cid){
    ...
    if($query){
     header("Location: ./inv_com_perangkat.php?ntf=4");                    
   } else {
       ...
       <div class="modal fade" id="myModal" role="dialog">
            ...
            <div class="modal-body">
              <form method="post" action=" ">
                ...
                <div class="form-group">
                  ...
                  <input type="Perangkat Komputer" name="pr_category" class="form-control" value="Perangkat Komputer" readonly="readonly">
        ...
        <div class="tables">
          ...
          <div class="panel-body widget-shadow">
            ...
            <h4>Asset Perangkat Komputer</h4>
            ...
            <table id="table_id" class="table table-bordered">
              ...
              <tbody id="myTable">
                ...
                $result = mysqli_query($con,"SELECT * FROM tb_product WHERE pr_category = 'Perangkat Komputer'");
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form method="post" action=" ">
                              ...
                              <div class="form-group">
                                <label>Product Category</label>
                                <input type="Perangkat Komputer" name="pr_category" class="form-control" value="<?php echo $row['pr_category'];?>" readonly="readonly">
