          ...
          <div class="panel-body widget-shadow">
            ...
            <table id="table_id" class="table table-bordered">
              ...
              <tbody id="myTable">
                ...
                $result = mysqli_query($con,"SELECT * FROM tb_log_history_req");
                ...
                if(mysqli_num_rows($result)>0){
                  ...
                  while($row = mysqli_fetch_array($result))
                  {
                    ...
                    echo "<tr>";
                    echo "<td><b>" . $no . ".</b></td>";
                    echo "<td>" . $row['his_id_req'] . "</td>";
                    echo "<td>" . $row['his_user_req'] . "</td>";
                    echo "<td>" . $row['his_product_req'] . "</td>";
                    echo "<td>" . $row['his_date_time_req'] . "</td>";
                    // echo "<td>" . $row['serial_no'] . "</td>";
                    // echo "<td>" . $row['serial_no'] . "</td>";
                    echo "<td>" . $row['his_task_req'] . "</td>";
                    echo "<td><b><i>" . $row['his_remark_req'] . "</i></b></td>";
