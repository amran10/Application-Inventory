...
{    
  ...
  $query = mysql_query("INSERT INTO tb_log_history_req (his_id_req,his_task_req, his_user_req, his_product_req, his_date_time_req, his_remark_req) VALUES 
          ...
          <div class="panel-body widget-shadow">
            ...
            <table id="table_id" class="table table-bordered">
              ...
              <tbody id="myTable">
                ...
                $result = mysqli_query($con,"SELECT * FROM tb_request_item WHERE set_status = 'Pendding'");
