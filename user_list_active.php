  ...
  <section id="container" >
    ...
    <section id="main-content">
      <section class="wrapper">
       <h5><i class="fa fa-angle-right"></i> Users / Users Active</h5>
            ...
            <div class="modal-body">
              <form method="post" action=" ">
                ...
                <div class="form-group">
                  ...
                  <input type="date" name="user_created" class="form-control" placeholder="Join Date"   required>
                </div>
                <div class="form-group">
          ...
          <section id="unseen" style="padding: 10px">
            <table  id="example1" class="table table-bordered table-striped table-condensed">
              ...
              <tbody>
                ...
                $result = mysqli_query($con,"SELECT * FROM tb_user WHERE user_status = 'Active' ORDER BY user_id ASC");
                $no=0;
